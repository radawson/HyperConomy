...
public class MultiServerTransferObject implements Serializable {
	...
	private MultiServerTransferType type;
	public MultiServerTransferObject(MultiServerTransferType type) {
		this.type = type;
	}
	public MultiServerTransferType getType() {
		return type;
	}
